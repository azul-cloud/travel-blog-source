...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogEntry.blog_site'
        db.alter_column('travel_blogentry', 'blog_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.BlogSite'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BlogEntry.blog_site'
        raise RuntimeError("Cannot reverse this migration. 'BlogEntry.blog_site' and its values cannot be restored.")
