...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Error_Instance'
        db.create_table('travel_error_instance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('error_desc', self.gf('django.db.models.fields.CharField')(max_length='200')),
            ('error_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_index=True, blank=True)),
            ('page', self.gf('django.db.models.fields.CharField')(max_length='200')),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ))
        db.send_create_signal('travel', ['Error_Instance'])

        # Adding field 'BannerPic.active'
        db.add_column('travel_bannerpic', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BannerPic.status'
        db.add_column('travel_bannerpic', 'status',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=1),
                      keep_default=False)


        # Changing field 'BannerPic.url'
        db.alter_column('travel_bannerpic', 'url', self.gf('django.db.models.fields.URLField')(max_length=100))

    def backwards(self, orm):
        # Deleting model 'Error_Instance'
        db.delete_table('travel_error_instance')

        # Deleting field 'BannerPic.active'
        db.delete_column('travel_bannerpic', 'active')

        # Deleting field 'BannerPic.status'
        db.delete_column('travel_bannerpic', 'status')


        # Changing field 'BannerPic.url'
        db.alter_column('travel_bannerpic', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
