...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogEntry.active_date'
        db.add_column('travel_blogentry', 'active_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'BlogEntry.status'
        db.add_column('travel_blogentry', 'status',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogEntry.active_date'
        db.delete_column('travel_blogentry', 'active_date')

        # Deleting field 'BlogEntry.status'
        db.delete_column('travel_blogentry', 'status')
    ...
    models = {
        ...
        'travel.bannerpic': {
            ...
            'active_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
