...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogEntry.image_title'
        db.add_column('travel_blogentry', 'image_title',
                      self.gf('django.db.models.fields.CharField')(default='Travel Blog Source', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogEntry.image_title'
        db.delete_column('travel_blogentry', 'image_title')
