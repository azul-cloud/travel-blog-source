...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Region.image'
        db.delete_column('travel_region', 'image')

        # Deleting field 'Region.image_title'
        db.delete_column('travel_region', 'image_title')

        # Deleting field 'Category.image'
        db.delete_column('travel_category', 'image')

        # Deleting field 'Category.image_title'
        db.delete_column('travel_category', 'image_title')


    def backwards(self, orm):
        # Adding field 'Region.image'
        db.add_column('travel_region', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.image_title'
        db.add_column('travel_region', 'image_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Category.image'
        db.add_column('travel_category', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_title'
        db.add_column('travel_category', 'image_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'travel.bannerpic': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['travel.Category']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'travel.category': {
            'Meta': {'ordering': "['display_value']", 'object_name': 'Category'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
