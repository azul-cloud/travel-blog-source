...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BlogSiteReview', fields ['review_date']
        db.create_index('travel_blogsitereview', ['review_date'])


    def backwards(self, orm):
        # Removing index on 'BlogSiteReview', fields ['review_date']
        db.delete_index('travel_blogsitereview', ['review_date'])
