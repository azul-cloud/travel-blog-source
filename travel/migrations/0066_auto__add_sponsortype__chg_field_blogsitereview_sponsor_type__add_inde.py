...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SponsorType'
        db.create_table('travel_sponsortype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sponsor_type', self.gf('django.db.models.fields.CharField')(default=0, max_length=30)),
        ))
        db.send_create_signal('travel', ['SponsorType'])


        # Renaming column for 'BlogSiteReview.sponsor_type' to match new field type.
        db.rename_column('travel_blogsitereview', 'sponsor_type', 'sponsor_type_id')
        # Changing field 'BlogSiteReview.sponsor_type'
        db.alter_column('travel_blogsitereview', 'sponsor_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.SponsorType'], null=True))
        # Adding index on 'BlogSiteReview', fields ['sponsor_type']
        db.create_index('travel_blogsitereview', ['sponsor_type_id'])

        # Adding field 'BlogSite.sponsor_level'
        db.add_column('travel_blogsite', 'sponsor_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.SponsorLevel'], null=True, blank=True),
                      keep_default=False)
        ...
        # Renaming column for 'BlogSite.sponsor_type' to match new field type.
        db.rename_column('travel_blogsite', 'sponsor_type', 'sponsor_type_id')
        # Changing field 'BlogSite.sponsor_type'
        db.alter_column('travel_blogsite', 'sponsor_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.SponsorType'], null=True))
        # Adding index on 'BlogSite', fields ['sponsor_type']
        db.create_index('travel_blogsite', ['sponsor_type_id'])


    def backwards(self, orm):
        # Removing index on 'BlogSite', fields ['sponsor_type']
        db.delete_index('travel_blogsite', ['sponsor_type_id'])

        # Removing index on 'BlogSiteReview', fields ['sponsor_type']
        db.delete_index('travel_blogsitereview', ['sponsor_type_id'])

        # Deleting model 'SponsorType'
        db.delete_table('travel_sponsortype')


        # Renaming column for 'BlogSiteReview.sponsor_type' to match new field type.
        db.rename_column('travel_blogsitereview', 'sponsor_type_id', 'sponsor_type')
        # Changing field 'BlogSiteReview.sponsor_type'
        db.alter_column('travel_blogsitereview', 'sponsor_type', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Deleting field 'BlogSite.sponsor_level'
        db.delete_column('travel_blogsite', 'sponsor_level_id')
        ...
        # Renaming column for 'BlogSite.sponsor_type' to match new field type.
        db.rename_column('travel_blogsite', 'sponsor_type_id', 'sponsor_type')
        # Changing field 'BlogSite.sponsor_type'
        db.alter_column('travel_blogsite', 'sponsor_type', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
    ...
    models = {
        ...
        'travel.blogsite': {
            ...
            'sponsor_level': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['travel.SponsorLevel']", 'null': 'True', 'blank': 'True'}),
            'sponsor_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['travel.SponsorType']", 'null': 'True', 'blank': 'True'}),
        ...
        'travel.sponsortype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sponsor_type': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '30'})
        }
    }
