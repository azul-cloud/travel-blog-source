...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogSite.continent'
        db.alter_column('travel_blogsite', 'continent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Continent'], null=True))

    def backwards(self, orm):

        # Changing field 'BlogSite.country'
        db.alter_column('travel_blogsite', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['travel.Country']))

        # Changing field 'BlogSite.continent'
        db.alter_column('travel_blogsite', 'continent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['travel.Continent']))
