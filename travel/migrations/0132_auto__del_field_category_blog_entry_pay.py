...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Category.blog_entry_pay'
        db.delete_column('travel_category', 'blog_entry_pay')


    def backwards(self, orm):
        # Adding field 'Category.blog_entry_pay'
        db.add_column('travel_category', 'blog_entry_pay',
