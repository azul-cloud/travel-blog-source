...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Error'
        db.create_table('travel_error', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('error_desc', self.gf('django.db.models.fields.CharField')(max_length='30')),
            ('erorr_text', self.gf('django.db.models.fields.CharField')(max_length='200')),
        ))
        db.send_create_signal('travel', ['Error'])


    def backwards(self, orm):
        # Deleting model 'Error'
        db.delete_table('travel_error')
    ...
    models = {
        ...
        'travel.error': {
            ...
            'erorr_text': ('django.db.models.fields.CharField', [], {'max_length': "'200'"}),
