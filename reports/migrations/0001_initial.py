...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reports_blogentryclick', (
        ...
        db.send_create_signal('reports', ['BlogEntryClick'])

        # Adding model 'BlogSiteClick'
        db.create_table('reports_blogsiteclick', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('reports', ['BlogSiteClick'])


    def backwards(self, orm):
        # Deleting model 'BlogEntryClick'
        db.delete_table('reports_blogentryclick')

        # Deleting model 'BlogSiteClick'
        db.delete_table('reports_blogsiteclick')
