...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogSiteReview.sponsor_level'
        db.delete_column('travel_blogsitereview', 'sponsor_level_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BlogSiteReview.sponsor_level'
        raise RuntimeError("Cannot reverse this migration. 'BlogSiteReview.sponsor_level' and its values cannot be restored.")
        # Deleting field 'BlogSiteReview.sponsor_type'
        db.delete_column('travel_blogsitereview', 'sponsor_type')
