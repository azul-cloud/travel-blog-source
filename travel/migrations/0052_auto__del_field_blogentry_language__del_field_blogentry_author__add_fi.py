...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('travel_blogentry', 'language')

        # Deleting field 'BlogEntry.author'
        db.delete_column('travel_blogentry', 'author')

        # Adding field 'BlogEntry.user'
        db.add_column('travel_blogentry', 'user',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BlogEntry.language'
        raise RuntimeError("Cannot reverse this migration. 'BlogEntry.language' and its values cannot be restored.")
        # Adding field 'BlogEntry.author'
        db.add_column('travel_blogentry', 'author',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Deleting field 'BlogEntry.user'
        db.delete_column('travel_blogentry', 'user_id')
