...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogSiteReview.user'
        db.delete_column('travel_blogsitereview', 'user_id')

        # Adding field 'BlogSiteReview.user_name'
        db.add_column('travel_blogsitereview', 'user_name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BlogSiteReview.user'
        raise RuntimeError("Cannot reverse this migration. 'BlogSiteReview.user' and its values cannot be restored.")
        # Deleting field 'BlogSiteReview.user_name'
        db.delete_column('travel_blogsitereview', 'user_name_id')
    ...
    models = {
        ...
        'travel.blogentry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'image_title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'travel.blogsitereview': {
            ...
            'sponsor_type': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '30', 'blank': 'True'}),
