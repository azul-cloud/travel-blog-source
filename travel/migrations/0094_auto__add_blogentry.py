...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('travel_blogentry', (
            ...
            ('blog_site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.BlogSite'], null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Country'], null=True, blank=True)),
            ('continent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Continent'], null=True, blank=True)),
