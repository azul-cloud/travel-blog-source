...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BannerPic.blog_site'
        db.delete_column('travel_bannerpic', 'blog_site_id')


    def backwards(self, orm):
        # Adding field 'BannerPic.blog_site'
        db.add_column('travel_bannerpic', 'blog_site',
