...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('travel_blogentry', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Country'], null=True),
                      keep_default=False)

        # Adding field 'BlogEntry.continent'
        db.add_column('travel_blogentry', 'continent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Continent'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'travel.blogentry': {
            ...
            'blog_site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['travel.BlogSite']", 'null': 'True'}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'continent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['travel.Continent']", 'null': 'True'}),
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['travel.Country']", 'null': 'True'}),
