...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogSite.primary_language'
        db.add_column('travel_blogsite', 'primary_language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogSite.primary_language'
        db.delete_column('travel_blogsite', 'primary_language')
