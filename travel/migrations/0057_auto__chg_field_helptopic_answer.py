...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HelpTopic.answer'
        db.alter_column('travel_helptopic', 'answer', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'HelpTopic.answer'
        db.alter_column('travel_helptopic', 'answer', self.gf('django.db.models.fields.CharField')(max_length=200))
