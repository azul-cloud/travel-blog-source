...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Continent.image'
        db.alter_column('travel_continent', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Country.image'
        db.alter_column('travel_country', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Continent.image'
        db.alter_column('travel_continent', 'image', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))

        # Changing field 'Country.image'
        db.alter_column('travel_country', 'image', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
