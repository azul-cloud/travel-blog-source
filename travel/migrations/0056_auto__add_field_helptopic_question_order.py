...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpTopic.question_order'
        db.add_column('travel_helptopic', 'question_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpTopic.question_order'
        db.delete_column('travel_helptopic', 'question_order')
