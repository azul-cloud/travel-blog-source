...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Feedback', fields ['submit_date']
        db.create_index('travel_feedback', ['submit_date'])


    def backwards(self, orm):
        # Removing index on 'Feedback', fields ['submit_date']
        db.delete_index('travel_feedback', ['submit_date'])
