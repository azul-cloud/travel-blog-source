...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('reports_blogsiteclick', 'location')

        # Adding field 'BlogSiteClick.blog_site'
        db.add_column('reports_blogsiteclick', 'blog_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.BlogSite'], null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'BlogSiteClick.origin'
        db.add_column('reports_blogsiteclick', 'origin',
                      self.gf('django.db.models.fields.CharField')(default='SEARCH', max_length=50),
                      keep_default=False)

        # Adding field 'BlogEntryClick.blog_entry'
        db.add_column('reports_blogentryclick', 'blog_entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.BlogEntry'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BlogSiteClick.location'
        db.add_column('reports_blogsiteclick', 'location',
                      self.gf('django.db.models.fields.CharField')(default='SEARCH', max_length=50),
                      keep_default=False)
        ...
        # Deleting field 'BlogSiteClick.origin'
        db.delete_column('reports_blogsiteclick', 'origin')
    ...
    models = {
        ...
        'reports.blogsiteclick': {
            ...
            'sponsor_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['travel.SponsorType']"})
        },
        'travel.blogentry': {
        ...
        'travel.blogsite': {
            ...
            'sponsor_level': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['travel.SponsorLevel']"}),
            'sponsor_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['travel.SponsorType']"}),
