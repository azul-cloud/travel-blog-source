...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogSite.blog_owner'
        db.alter_column('travel_blogsite', 'blog_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BlogSite.blog_owner'
        db.alter_column('travel_blogsite', 'blog_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.BlogOwner']))
