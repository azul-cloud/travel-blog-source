...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.blog_entry_pay'
        db.add_column('travel_country', 'blog_entry_pay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Country.banner_pic_pay'
        db.add_column('travel_country', 'banner_pic_pay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.blog_entry_pay'
        db.delete_column('travel_country', 'blog_entry_pay')

        # Deleting field 'Country.banner_pic_pay'
        db.delete_column('travel_country', 'banner_pic_pay')
