...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogSite.twitter_id'
        db.alter_column('travel_blogsite', 'twitter_id', self.gf('django.db.models.fields.CharField')(max_length='30', null=True))

    def backwards(self, orm):

        # Changing field 'BlogSite.twitter_id'
        db.alter_column('travel_blogsite', 'twitter_id', self.gf('django.db.models.fields.IntegerField')(null=True))
