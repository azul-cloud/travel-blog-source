...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feedback.status'
        db.alter_column('travel_feedback', 'status', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Feedback.feedback'
        db.alter_column('travel_feedback', 'feedback', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Feedback.status'
        db.alter_column('travel_feedback', 'status', self.gf('django.db.models.fields.CharField')(default='Submitted', max_length=30))

        # Changing field 'Feedback.feedback'
        db.alter_column('travel_feedback', 'feedback', self.gf('django.db.models.fields.CharField')(max_length=1000))
