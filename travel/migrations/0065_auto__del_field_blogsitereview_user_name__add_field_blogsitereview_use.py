...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogSiteReview.user'
        db.add_column('travel_blogsitereview', 'user',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BlogSiteReview.user_name'
        raise RuntimeError("Cannot reverse this migration. 'BlogSiteReview.user_name' and its values cannot be restored.")
