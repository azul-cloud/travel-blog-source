...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BannerPic.category'
        db.add_column('travel_bannerpic', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BannerPic.category'
        db.delete_column('travel_bannerpic', 'category_id')
