...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'BlogSiteClick.sponsor_type' to match new field type.
        db.rename_column('reports_blogsiteclick', 'sponsor_type_id', 'sponsor_type')
        # Changing field 'BlogSiteClick.sponsor_type'
        db.alter_column('reports_blogsiteclick', 'sponsor_type', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Removing index on 'BlogSiteClick', fields ['sponsor_type']
        db.delete_index('reports_blogsiteclick', ['sponsor_type_id'])
    ...
    def backwards(self, orm):
        # Adding index on 'BlogSiteClick', fields ['sponsor_type']
        db.create_index('reports_blogsiteclick', ['sponsor_type_id'])


        # Renaming column for 'BlogSiteClick.sponsor_type' to match new field type.
        db.rename_column('reports_blogsiteclick', 'sponsor_type', 'sponsor_type_id')
        # Changing field 'BlogSiteClick.sponsor_type'
        db.alter_column('reports_blogsiteclick', 'sponsor_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.SponsorType'], null=True))
