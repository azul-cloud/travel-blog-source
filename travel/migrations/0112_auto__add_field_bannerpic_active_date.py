...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BannerPic.active_date'
        db.add_column('travel_bannerpic', 'active_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BannerPic.active_date'
        db.delete_column('travel_bannerpic', 'active_date')
