...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Error.erorr_text'
        db.delete_column('travel_error', 'erorr_text')

        # Adding field 'Error.error_text'
        db.add_column('travel_error', 'error_text',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length='200'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Error.erorr_text'
        db.add_column('travel_error', 'erorr_text',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length='200'),
                      keep_default=False)

        # Deleting field 'Error.error_text'
        db.delete_column('travel_error', 'error_text')
