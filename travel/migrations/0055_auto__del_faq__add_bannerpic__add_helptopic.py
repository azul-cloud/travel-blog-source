...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BannerPic'
        db.create_table('travel_bannerpic', (
        ...
        db.send_create_signal('travel', ['BannerPic'])

        # Adding model 'HelpTopic'
        db.create_table('travel_helptopic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('sub_group', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('travel', ['HelpTopic'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'BannerPic'
        db.delete_table('travel_bannerpic')

        # Deleting model 'HelpTopic'
        db.delete_table('travel_helptopic')
