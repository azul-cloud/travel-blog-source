...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BannerPicCLick.click_date'
        db.add_column('reports_bannerpicclick', 'click_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 11, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BannerPicCLick.click_date'
        db.delete_column('reports_bannerpicclick', 'click_date')
