...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('travel_region', 'region_type',
                      self.gf('django.db.models.fields.CharField')(default='Country', max_length=30),
                      keep_default=False)


        # Renaming column for 'Region.continent' to match new field type.
        db.rename_column('travel_region', 'continent_id', 'continent')
        # Changing field 'Region.continent'
        db.alter_column('travel_region', 'continent', self.gf('django.db.models.fields.CharField')(max_length=3))
        # Removing index on 'Region', fields ['continent']
        db.delete_index('travel_region', ['continent_id'])

        # Deleting field 'BannerPic.country'
        db.delete_column('travel_bannerpic', 'country_id')

        # Deleting field 'BannerPic.continent'
        db.delete_column('travel_bannerpic', 'continent_id')

        # Adding field 'BannerPic.region'
        db.add_column('travel_bannerpic', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Region'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BlogEntry.country'
        db.delete_column('travel_blogentry', 'country_id')

        # Deleting field 'BlogEntry.continent'
        db.delete_column('travel_blogentry', 'continent_id')

        # Adding field 'BlogEntry.region'
        db.add_column('travel_blogentry', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Region'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BlogSite.country'
        db.delete_column('travel_blogsite', 'country_id')

        # Deleting field 'BlogSite.continent'
        db.delete_column('travel_blogsite', 'continent_id')
    ...
    def backwards(self, orm):
        # Adding index on 'Region', fields ['continent']
        db.create_index('travel_region', ['continent_id'])
        ...
        db.delete_column('travel_region', 'region_type')


        # Renaming column for 'Region.continent' to match new field type.
        db.rename_column('travel_region', 'continent', 'continent_id')
        # Changing field 'Region.continent'
        db.alter_column('travel_region', 'continent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Continent']))
        # Adding field 'BannerPic.country'
        db.add_column('travel_bannerpic', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Region'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BannerPic.continent'
        db.add_column('travel_bannerpic', 'continent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Continent'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BannerPic.region'
        db.delete_column('travel_bannerpic', 'region_id')

        # Adding field 'BlogEntry.country'
        db.add_column('travel_blogentry', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Region'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlogEntry.continent'
        db.add_column('travel_blogentry', 'continent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Continent'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BlogEntry.region'
        db.delete_column('travel_blogentry', 'region_id')

        # Adding field 'BlogSite.country'
        db.add_column('travel_blogsite', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Region'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlogSite.continent'
        db.add_column('travel_blogsite', 'continent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.Continent'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'travel.region': {
            ...
            'continent': ('django.db.models.fields.CharField', [], {'default': "'WOR'", 'max_length': '3'}),
