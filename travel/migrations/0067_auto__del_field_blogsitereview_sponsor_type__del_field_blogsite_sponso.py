...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogSiteReview.sponsor_type'
        db.delete_column('travel_blogsitereview', 'sponsor_type_id')

        # Deleting field 'BlogSite.sponsor_type'
        db.delete_column('travel_blogsite', 'sponsor_type_id')
    ...
    def backwards(self, orm):
        # Adding field 'BlogSiteReview.sponsor_type'
        db.add_column('travel_blogsitereview', 'sponsor_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['travel.SponsorType'], null=True, blank=True),
                      keep_default=False)
