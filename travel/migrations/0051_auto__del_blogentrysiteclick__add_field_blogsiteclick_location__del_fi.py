...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogSiteClick.location'
        db.add_column('travel_blogsiteclick', 'location',
                      self.gf('django.db.models.fields.CharField')(default='SEARCH', max_length=50),
                      keep_default=False)

        # Deleting field 'BlogEntry.views'
        db.delete_column('travel_blogentry', 'views')

        # Deleting field 'BlogEntry.country'
        db.delete_column('travel_blogentry', 'country_id')

        # Adding field 'BlogEntry.blog_site'
        db.add_column('travel_blogentry', 'blog_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=8, to=orm['travel.BlogSite']),
                      keep_default=False)


        # Changing field 'BlogEntry.title'
        db.alter_column('travel_blogentry', 'title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BlogSiteClick.location'
        db.delete_column('travel_blogsiteclick', 'location')


        # User chose to not deal with backwards NULL issues for 'BlogEntry.views'
        raise RuntimeError("Cannot reverse this migration. 'BlogEntry.views' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'BlogEntry.country'
        raise RuntimeError("Cannot reverse this migration. 'BlogEntry.country' and its values cannot be restored.")
        # Deleting field 'BlogEntry.blog_site'
        db.delete_column('travel_blogentry', 'blog_site_id')


        # Changing field 'BlogEntry.title'
        db.alter_column('travel_blogentry', 'title', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
