...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Continent.blog_entry_pay'
        db.add_column('travel_continent', 'blog_entry_pay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Continent.banner_pic_pay'
        db.add_column('travel_continent', 'banner_pic_pay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Continent.blog_entry_pay'
        db.delete_column('travel_continent', 'blog_entry_pay')

        # Deleting field 'Continent.banner_pic_pay'
        db.delete_column('travel_continent', 'banner_pic_pay')
